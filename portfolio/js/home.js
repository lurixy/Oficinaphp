...
function toggleTheme(_event){
    ...
    if(isDark){
        ...
        redes.innerHTML = `<ul>
            <li><a href="https://www.instagram.com/lurixy" target="_blank"><img src="./images/instagram.svg"></a></li>
            <li><a href="https://www.linkedin.com/" target="_blank"><img src="./images/linked.svg"></a></li>
            <li><a href="https://github.com/lurixy" target="_blank"><img src="./images/github.svg"></a></li>
        </ul>`
    }
}
